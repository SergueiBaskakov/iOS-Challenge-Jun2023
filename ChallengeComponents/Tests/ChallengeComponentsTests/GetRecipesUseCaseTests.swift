...
final class GetRecipesSuccessUseCaseTests: XCTestCase {
    ...
    func testGetRecipes() throws {
        ...
        let getRecipeInteractor: GetRecipesUseCase = Resolver.resolve()
...
final class GetRecipesFailUseCaseTests: XCTestCase {
